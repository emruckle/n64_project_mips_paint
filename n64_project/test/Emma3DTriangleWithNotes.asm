...
PointX:
  dh -2000,  2000, 0,  -2000, 2000, 0, 0, 0 // 8 * Point X (S15) (Signed Integer)
PointY:
  dh  0,  0, -2000, 0,  0, -2000, 0, 0 // 8 * Point Y (S15) (Signed Integer)
PointZ:
  dh -1000, -1000, -1000, 1000,  1000, 1000,  0, 0 // 8 * Point Z (S15) (Signed Integer)
...
arch n64.rdp
  ...
  // how does it know where the points are located????? this is my current question
