// N64 'Bare Metal' 32BPP 320x240 Fill Rectangle RDP Demo by krom (Peter Lemon) edited so much by me
// this draws the paint palette from mips paint using RDP instead of CPU
// Sync_Pipe!! important
// old notes:
...
arch n64.rdp
//Sync_Load
      // emulator runs with these commented out, console does not
 Set_Scissor 0<<2,0<<2, 0,0, 320<<2,240<<2 // Set Scissor: XH 0.0,YH 0.0, Scissor Field Enable Off,Field Off, XL 320.0,YL 240.0
 Set_Other_Modes CYCLE_TYPE_FILL // Set Other Modes
